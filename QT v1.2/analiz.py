...
class Ui_MainWindow(object):
    ...
    def update_graph(self,data1,data2,data3,data4,data5,data6):
        ...
        # self.MplWidget1.canvas.axes.plot(self.t1, list(np.array(self.signal1).T[1]))
                ...
                if self.S_list[i] =='None':
                    ...
                    try:
                        ...
                        if thiscurdata[0][0]=='.':
                            ...
                            curdata = list(map(float, thiscurdata[0:len(thiscurdata) - 1]))
                            if max(curdata[0:len(curdata)-3])>5:
                                cnt+=1
                                # data[i] = ['0.0000','0.0000','0.0000']
                            # else:
                            data[i] = curdata
                            lenth[i] = len(curdata)-3
                            # print(data[i])
