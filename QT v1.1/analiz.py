...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.label_5.setGeometry(QtCore.QRect(40, 400, 61, 16))
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Scentruth INTERFACE 1.1"))
    ...
    def update_graph(self,data1,data2,data3,data4,data5,data6):
        ...
        self.signal1.append(float(data1[:6]))
        self.signal2.append(float(data2[:6]))
        self.signal3.append(float(data3[:6]))
        self.signal4.append(float(data4[:6]))
        self.signal5.append(float(data5[:6]))
        self.signal6.append(float(data6[:6]))
        ...
        # self.MplWidget1.set_y()
        self.MplWidget1.canvas.axes.plot(self.t1, self.signal1)
        # self.MplWidget1.canvas.axes.legend(('Sensor1'),loc='upper right')
        self.MplWidget1.canvas.axes.set_title('DATA1 Signal')
        self.MplWidget1.canvas.axes.set_ylim(0, 2)
        # self.MplWidget1.canvas.axes.xticks(fontsize=5)
        self.MplWidget1.canvas.axes.xaxis.set_major_locator(ticker.MultipleLocator(tick_spacing))
        # self.MplWidget1.canvas.axes.y_major_locator = MultipleLocator(10)
        ...
        self.MplWidget2.canvas.axes.set_ylim(0, 2)
        ...
        self.MplWidget3.canvas.axes.set_ylim(0, 2)
        ...
        self.MplWidget4.canvas.axes.set_ylim(0, 2)
        ...
        self.MplWidget5.canvas.axes.set_ylim(0, 2)
        ...
        self.MplWidget6.canvas.axes.set_ylim(0, 2)
    ...
    def check_multi_serial_event(self):
        if self._isRunning==1:
            ...
            for i in range(len(self.S_list)):
                ...
                if self.S_list[i] =='None':
                    ...
                    try:
                        ...
                        if float(thiscurdata[0])>5 or thiscurdata[0][0]=='.':
                            cnt+=1
                            data[i] =['0.0000','0.0000','0.0000']
                        else:
                            data[i] = thiscurdata
            ...
            self.update_graph(data[0][0],data[1][0],data[2][0],data[3][0],data[4][0],data[5][0])
            self.cnnt+=1
            th_1.start()
        else:
            print("See ya!")
